...
public class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> De = new()
    {
        ...
        ["onboarding.step9_title"] = "Benachrichtigungen aktivieren",
        ["onboarding.step9_body"] = "Lass dich aufs Handy benachrichtigen, wenn dir ein Ticket zugewiesen wird oder es Neuigkeiten gibt — auch wenn die App geschlossen ist. Du kannst das jederzeit in den Einstellungen ändern.",
        ["onboarding.push_enable"] = "Push aktivieren",
        ["onboarding.push_enabled"] = "Push ist aktiviert",
        ["onboarding.push_unsupported"] = "Push wird auf diesem Gerät nicht unterstützt.",
        ...
        ["detail.link_added"] = "Verknüpfung hinzugefügt",
        ["detail.link_removed"] = "Verknüpfung entfernt",
        ["detail.link_failed"] = "Verknüpfung fehlgeschlagen",
        ["detail.link_self"] = "Ein Ticket kann nicht mit sich selbst verknüpft werden.",
        ["detail.link_offline"] = "Verknüpfungen sind nur online möglich.",
        ...
        ["assets.empty_description"] = "Lege Fahrzeuge, Geräte oder Material an, um sie mit Tickets zu verknüpfen.",
        ...
        ["templates.type_required"] = "Typ ist erforderlich.",
        ["templates.priority_required"] = "Priorität ist erforderlich.",
        ...
        ["recurring.empty_description"] = "Erstelle wiederkehrende Aufgaben, die automatisch Tickets nach Zeitplan anlegen.",
        ...
        ["settings.private_tickets"] = "Privater Ticket-Bereich",
        ["settings.private_tickets_desc"] = "Erstellt eine persönliche, nur für dich sichtbare Gruppe für Entwürfe und Tickets, die niemand sonst sehen soll. Kann später jederzeit über einen Gruppenwechsel veröffentlicht werden.",
        ["settings.private_tickets_enable"] = "Privaten Bereich aktivieren",
        ["settings.private_tickets_enabled"] = "Privater Ticket-Bereich ist aktiv.",
        ["settings.private_tickets_enable_failed"] = "Privater Bereich konnte nicht aktiviert werden.",
        ["groups.private_label"] = "🔒 Privater Bereich",
        ...
        ["settings.connection_invalid_url"] = "Ungültige URL. Bitte eine vollständige http(s)-Adresse angeben.",
        ...
        ["batch.assigned_to"] = "{0} an „{1}“ zugewiesen, {2} fehlgeschlagen",
        ["batch.delete_confirm_title"] = "Tickets löschen?",
        ["batch.delete_confirm"] = "{0} Ticket(s) werden endgültig gelöscht. Das kann nicht rückgängig gemacht werden.",
        ...
        ["tickets.priority_required"] = "Bitte eine Priorität wählen.",
        ...
        ["tickets.attachments_too_many"] = "Zu viele Dateien auf einmal (max. 50).",
        ["tickets.attachments_read_failed"] = "{0} konnte nicht gelesen werden.",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["onboarding.step9_title"] = "Enable notifications",
        ["onboarding.step9_body"] = "Get notified on your phone when a ticket is assigned to you or there's an update — even when the app is closed. You can change this any time in Settings.",
        ["onboarding.push_enable"] = "Enable push",
        ["onboarding.push_enabled"] = "Push is enabled",
        ["onboarding.push_unsupported"] = "Push is not supported on this device.",
        ...
        ["detail.link_added"] = "Link added",
        ["detail.link_removed"] = "Link removed",
        ["detail.link_failed"] = "Linking failed",
        ["detail.link_self"] = "A ticket cannot be linked to itself.",
        ["detail.link_offline"] = "Linking is only available online.",
        ...
        ["assets.empty_description"] = "Add vehicles, equipment or material to link them to tickets.",
        ...
        ["templates.type_required"] = "Type is required.",
        ["templates.priority_required"] = "Priority is required.",
        ...
        ["recurring.empty_description"] = "Create recurring tasks that automatically open tickets on a schedule.",
        ...
        ["settings.private_tickets"] = "Private ticket space",
        ["settings.private_tickets_desc"] = "Creates a personal group visible only to you, for drafts and tickets nobody else should see. Can be published to a real group any time via a group change.",
        ["settings.private_tickets_enable"] = "Enable private space",
        ["settings.private_tickets_enabled"] = "Private ticket space is active.",
        ["settings.private_tickets_enable_failed"] = "Could not enable the private space.",
        ["groups.private_label"] = "🔒 Private space",
        ...
        ["settings.connection_invalid_url"] = "Invalid URL. Please enter a full http(s) address.",
        ...
        ["batch.assign_to"] = "Assign to…",
        ["batch.deleted"] = "{0} deleted, {1} failed",
        ["batch.updated"] = "{0} updated, {1} failed",
        ["batch.status_changed"] = "{0} changed to '{1}', {2} failed",
        ["batch.assigned_to"] = "{0} assigned to '{1}', {2} failed",
        ["batch.delete_confirm_title"] = "Delete tickets?",
        ["batch.delete_confirm"] = "{0} ticket(s) will be permanently deleted. This cannot be undone.",
        ...
        ["tickets.priority_required"] = "Please select a priority.",
        ...
        ["tickets.attachments_too_many"] = "Too many files at once (max 50).",
        ["tickets.attachments_read_failed"] = "Could not read {0}.",
